...
# SOURCE FILES
GAME_SOURCES  = main.cpp src/render.cpp src/entity.cpp src/snake.cpp  src/sounds.cpp src/state.cpp src/uiStates.cpp src/stateController.cpp src/engine.cpp
